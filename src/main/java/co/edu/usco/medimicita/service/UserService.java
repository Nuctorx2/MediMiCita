...
import co.edu.usco.medimicita.dto.UserRegistrationDto; // Crearemos este DTO
import co.edu.usco.medimicita.entity.UserEntity;
import org.springframework.security.core.userdetails.UserDetailsService; // Para la integración con Spring Security

import java.util.List;
import java.util.Optional;

public interface UserService extends UserDetailsService { // (1) Extiende UserDetailsService
    ...
    // UserEntity updateProfile(Long userId, UserProfileUpdateDto profileUpdateDto);
}